    ...
    try:
        ...
        <head>
            ...
            * {{ box-sizing: border-box; }}
            ...
            /* TARJETAS - 6 COLUMNAS, MÁS BAJAS */
            .resumen {{ display: grid; grid-template-columns: repeat(6, 1fr); gap: 15px; margin: 20px 0; }}
            .tarjeta {{ background: white; padding: 15px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-left: 4px solid; }}
            ...
            .tarjeta .valor {{ font-size: 1.3em; font-weight: bold; margin: 5px 0; line-height: 1.2; }}
            ...
            /* TABLAS - FULL WIDTH, UNA DEBAJO DE OTRA */
            table {{ width: 100%; border-collapse: collapse; margin: 15px 0; background: white; border-radius: 6px; overflow: hidden; display: table; }}
