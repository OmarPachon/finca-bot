    ...
    try:
        ...
        <head>
            ...
            * {{ box-sizing: border-box; }}
            ...
            h2 {{ color: #198754; font-size: 1.2em; margin-top: 20px; margin-bottom: 10px; }}
            ...
            .tarjeta h3 {{ color: #6c757d; font-size: 0.75em; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 5px; }}
            .tarjeta .valor {{
            font-size: 1.3em;
            font-weight: bold;
            color: #2c3e50;
